...
from .views import login_view, logout_view, register_view, delete_user, UserProfileView, toggle_favorite
...
urlpatterns += static(settings.STATIC_URL, document_root=settings.STATIC_ROOT) #For static files (styles.css)
